    ...
    <div class="register-form">
        ...
        <n-form ref="formRef" :model="model" :rules="rules" class="form-group">
            ...
            <n-form-item path="password1" label="密码" class="form-group">
                <n-input v-model:value="model.password1" type="password" placeholder="请输入密码"
                    @input="handlePasswordInput" :input-props="{ autocomplete: 'new-password' }" />
            </n-form-item>
            <n-form-item path="password2" label="确认密码" ref="password2Ref" first class="form-group">
                <n-input v-model:value="model.password2" type="password" placeholder="请确认密码"
...
const handleRegister = (event) => {
    ...
    formRef.value
        ...
        .then(() => {
            try {
                post("/accounts/signup/", new URLSearchParams({
